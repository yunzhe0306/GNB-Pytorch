...
def get_GNB_parameters(dataset):
    ...
    # --------------------------------------------------------------
    if dataset == "mnist_only":
        parser.add_argument('--dataset', default='mnist_only', type=str, help='mnist_only, yelp, movie_real, shuttle')
        #
        ...
        #####
        parser.add_argument('--dataset', default='yelp', type=str, help='mnist_only, yelp, movie_real, shuttle')
        #
        parser.add_argument('--GNN_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--user_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--bw_reward', default=5, type=float, help='Kernel bandwidth for exploitation GNN')
    ...
    elif dataset == "movie_real":
        parser.add_argument('--dataset', default='movie_real', type=str, help='mnist_only, yelp, movie_real, shuttle')
        #
        parser.add_argument('--GNN_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--user_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--bw_reward', default=0.1, type=float, help='Kernel bandwidth for exploitation GNN')
        parser.add_argument('--bw_conf_b', default=0.1, type=float, help='Kernel bandwidth for exploration GNN')
        parser.add_argument('--k', default=1, type=int, help='k-th user neighborhood over user graphs')
        parser.add_argument('--batch_size', default=-1, type=int, help='Batch size for training')
        parser.add_argument('--GNN_pool_step_size', default=1000, type=int, help='Step size for GNN gradient pooling')
        parser.add_argument('--user_pool_step_size', default=100, type=int, help='Step size for user gradient pooling')
        ...
        parser.add_argument('--dataset', default='shuttle', type=str, help='mnist_only, yelp, movie_real, shuttle')
        #
        parser.add_argument('--GNN_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--user_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--bw_reward', default=5, type=float, help='Kernel bandwidth for exploitation GNN')
        ...
        parser.add_argument('--dataset', default='letter', type=str, help='mnist_only, yelp, movie_real, shuttle')
        #
        parser.add_argument('--GNN_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--user_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--bw_reward', default=5, type=float, help='Kernel bandwidth for exploitation GNN')
        ...
        parser.add_argument('--dataset', default='pendigits', type=str, help='mnist_only, yelp, movie_real, shuttle')
        #
        parser.add_argument('--GNN_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--user_lr', default=0.0001, type=float, help='Learning rates for GNN models')
        parser.add_argument('--bw_reward', default=5, type=float, help='Kernel bandwidth for exploitation GNN')
        ...
        parser.add_argument('--k', default=1, type=int, help='k-th user neighborhood over user graphs')
        parser.add_argument('--batch_size', default=-1, type=int, help='Batch size for training')
        parser.add_argument('--GNN_pool_step_size', default=2000, type=int, help='Step size for GNN gradient pooling')
        parser.add_argument('--user_pool_step_size', default=100, type=int, help='Step size for user gradient pooling')
